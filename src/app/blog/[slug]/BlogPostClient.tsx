...
export default function BlogPostClient() {
    ...
    return (
        <div className="prose dark:prose-invert max-w-2xl">
            ...
            <p>
                Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam ac vestibulum erat. Cras vulputate auctor lectus at consequat. Donec
                nec eros eget nisl fringilla commodo. Morbi sit amet nulla sed arcu pulvinar ultricies. Proin convallis, ligula a tincidunt cursus,
                mauris erat facilisis urna, at convallis erat libero nec nisi.
            </p>
            <p>
