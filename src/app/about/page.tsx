...
export default function About() {
    ...
    return (
        <FooterRevealLayout triggerRef={faqRef}>
                ...
                <div className="flex flex-col gap-8 md:w-full">
                    ...
                    <div className="flex flex-col gap-8 md:flex-row md:items-center md:justify-between">
                        ...
                        <p className="body-medium w-full md:w-1/3">
                            I'm dedicated to crafting beautiful and highly functional designs that seamlessly align with my clients' unique needs and
                            long-term goals.
                        </p>
                    </div>
                </div>
