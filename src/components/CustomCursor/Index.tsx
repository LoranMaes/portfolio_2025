...
export default function CustomCursor() {
	...
	return (
		<div
			ref={cursor}
			className="bg-background fixed top-0 transition-[width,_height] duration-150 ease-in left-0 z-20 rounded-full mix-blend-difference pointer-events-none cursor-none"
